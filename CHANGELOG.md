...
All notable changes to the TWIN-EB website are documented here.
The format is based on [Keep a Changelog](https://keepachangelog.com/), and the
project uses [Semantic Versioning](https://semver.org/).

## [0.1.0-beta] – 2026-07-11

First tracked release. The site is live on GitHub Pages.

### Added
- Eight-page structure: Home, EB & RDEB, Losartan in RDEB, Virtual Twins, Project, Team, Publications, For families.
- Publications entry for the open-access digital-twins review (Dette et al., *Comput Struct Biotechnol J* 2025).
...
- Initial static project website (early exploration, not formally tracked).
